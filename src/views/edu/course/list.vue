<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="buyCount" label="付费学员" width="100" align="center"><template slot-scope="scope">
      ...
      <el-table-column label="操作" width="150" align="center">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="mini" icon="el-icon-delete" @click="deleteSelectCourse(scope.row.id)">
            删除
          </el-button>
        </template>
      </el-table-column>
